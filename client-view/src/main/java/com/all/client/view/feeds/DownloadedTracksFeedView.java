...
public class DownloadedTracksFeedView extends FeedView<TrackContentFeed> {
	private static final long serialVersionUID = 1L;
	public static final int MAXIMUM_ENTITIES = 3;
	private static final String SPACER = "    ";

	public DownloadedTracksFeedView(TrackContentFeed feed, Messages messages, ViewEngine viewEngine,
			DialogFactory dialogFactory) {
		super(feed, FeedIconType.DOWNLOADED_TRACKS, FeedSize.LARGE, messages, viewEngine, dialogFactory);
	...
	public void internationalize(Messages messages) {
		...
		getHeaderPanel().appendText(messages.getMessage("feed.downloadcount.title"));
		...
		if (feed.getTrackCount() > MAXIMUM_ENTITIES) {
			...
			String message = messages.getMessage("feed.sendMedia.numberOfTracks", "" + (feed.getTrackCount() - MAXIMUM_ENTITIES));
