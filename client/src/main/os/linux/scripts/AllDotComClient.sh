...
export LIB_BROWSER="`pwd`/System/mozilla"
export LIBRARY_PATH="$LIB_PATH:$LIB_BROWSER"

export CP="./System:`buildClassPath $JAR_DIR`"


export ALL_CLIENT_LAUNCHER="-Xmx1024m -Xms128m -Djava.library.path=$LIBRARY_PATH -Djna.library.path=$LIBRARY_PATH -cp $CP com.all.launcher.Main"

#uncomment and set this variable to point to a supported Java Virtual Machine installation path
#export JAVA_HOME=
